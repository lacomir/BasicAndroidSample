 ...
 *
 * https://hadoop.apache.org/docs/r1.0.4/api/org/apache/hadoop/examples/dancing/DancingLinks.html
 * https://apache.googlesource.com/hadoop-mapreduce/+/MAPREDUCE-233/src/examples/org/apache/hadoop/examples/dancing/DancingLinks.java
 */
...
public class DancingLinks<ColumnName> {
     ...
     * column to explore.
     */
    private class ColumnHeader<ColumnName> extends Node<ColumnName> {
        ColumnName name;
        int size;
